...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(@NonNull Context context, @NonNull PickerOptionListener listener) {
    ...
    public static void showImagePDFPickerOptions(@NonNull Context context, @NonNull PickerOptionListener listener) {
        // setup the alert builder
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle("Select Image");

        // add a list
        String[] animals = {"Take a picture", "Choose from File"};
        builder.setItems(animals, (dialog, which) -> {
            switch (which) {
                case 0:
                    listener.onTakeCameraSelected();
    ...
    private static String queryName(@NonNull ContentResolver resolver, @NonNull Uri uri) {
        Cursor returnCursor =
    ...
    private void takeCameraImage() {
        Dexter.withActivity(this)
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    @Override
                    public void onPermissionRationaleShouldBeShown(List<PermissionRequest> permissions, @NonNull PermissionToken token) {
    ...
    private void cropImage(@NonNull Uri sourceUri) {
        target = sourceUri;
        Uri destinationUri = Uri.fromFile(new File(getExternalCacheDir(), queryName(getContentResolver(), sourceUri)));
//        Uri destinationUri = getCacheImagePath(fileName);
...
//        Crop.of(sourceUri, sourceUri).start(this);
    }

    private void handleUCropResult(@Nullable Intent data) {
        if (data == null) {
            setResultCancelled();
            return;
        }
